...
<body>
    ...
    <div class="container-fluid page-header py-6 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center pt-5 pb-3">
            <h1 class="display-4 text-white animated slideInDown mb-3">{{ __('messages.add_bakery') }}</h1>
    ...
    <div class="container-xxl bg-light my-6 py-6 pt-0" >
        <div class="container">
            ...
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px; padding-top: 80px;">
                <p class="text-primary text-uppercase mb-2">{{ __('messages.create_product') }}</p>
                <h1 class="display-6 mb-4">{{ __('messages.input_bakery') }}</h1>
            </div>
            <div class="container">
<div class="container py-6">
    <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label for="gambar" class="form-label">{{ __('messages.image_bakery') }}</label>
